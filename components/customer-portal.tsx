...
const groups: PortalNavGroup[] = [
  {
    ...
    items: [
      { id: 'overview', label: 'Overview', icon: LayoutDashboard , translationKey: 'nav.overview' },
      { id: 'crm', label: 'Advanced CRM', icon: Target , translationKey: 'nav.crm' },
      { id: 'agents', label: 'AI agents', icon: Bot , translationKey: 'nav.agents' },
      { id: 'voice_profiles', label: 'Voice profiles', icon: Mic2 , translationKey: 'nav.voice_profiles' },
      { id: 'graph_agents', label: 'Graph agents', icon: GitBranch , translationKey: 'nav.graph_agents' },
      { id: 'workflows', label: 'Workflows', icon: Workflow , translationKey: 'nav.workflows' },
      { id: 'knowledge', label: 'Knowledge base', icon: BookOpenText , translationKey: 'nav.knowledge' },
      { id: 'campaigns', label: 'Campaigns', icon: Radio, badge: 'Live' },
      { id: 'numbers', label: 'My numbers', icon: Globe2 , translationKey: 'nav.numbers' },
      { id: 'sip_trunks', label: 'SIP trunks', icon: Cable , translationKey: 'nav.sip_trunks' },
    ],
  },
  {
    label: 'Observe',
    items: [
      { id: 'call_history', label: 'Call history', icon: PhoneCall , translationKey: 'nav.call_history' },
      {
        id: 'live_monitor',
      ...
      { id: 'analytics', label: 'Analytics', icon: BarChart3 , translationKey: 'nav.analytics' },
      { id: 'quality', label: 'AI quality assurance', icon: FileAudio , translationKey: 'nav.quality' },
      { id: 'alerts', label: 'Alerts', icon: AlertTriangle , translationKey: 'nav.alerts' },
      { id: 'reports', label: 'Reports', icon: FileBarChart2 , translationKey: 'nav.reports' },
    ],
  },
  {
    label: 'Grow',
    ...
    items: [
      { id: 'lead_capture', label: 'Lead capture', icon: Megaphone , translationKey: 'nav.lead_capture' },
      { id: 'retargeting', label: 'Retargeting', icon: Repeat2 , translationKey: 'nav.retargeting' },
      {
        id: 'commerce',
        label: 'AI commerce',
      ...
      { id: 'integrations', label: 'Integrations & API', icon: Webhook , translationKey: 'nav.integrations' },
    ],
  },
  {
    label: 'Manage',
    ...
    items: [
      { id: 'billing', label: 'Billing & credits', icon: CreditCard , translationKey: 'nav.billing' },
      ...
      { id: 'settings', label: 'Settings', icon: Settings2 , translationKey: 'nav.settings' },
    ],
  },
];
