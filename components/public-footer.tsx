...
export function PublicFooter() {
  return <footer className="vani-public-footer">
    <div className="vani-footer-top">
      <div className="vani-footer-brand"><span><Activity className="size-6" /></span><div><strong>VANI</strong><p>Good conversations. Meaningful next steps.</p></div></div>
    ...
    <div className="vani-footer-bottom"><span>© {new Date().getFullYear()} VANI. All rights reserved.</span><span>Voice · Workflows · Business</span></div>
    <div className="vani-footer-wordmark" aria-hidden="true">vani<span>.</span></div>
  </footer>;
}
