...
Not completed: unified live voice duration/turn settlement; durable reconciliation UI/jobs; complete WhatsApp drag/drop bot and Flows publish/runtime; Meta Embedded Signup lifecycle; recurring subscription invoice handling; full role/plan enforcement; production storage/credential lifecycle and live connector acceptance. See `PRODUCT_AUDIT_2026-09-08.md` for the remaining P0/P1 checklist. These are not all missing-key blockers—several still need code.
