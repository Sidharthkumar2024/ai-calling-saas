...
const en = {
  ...
  'nav.playbook': 'Company playbook',
  'nav.documents': 'Document inbox',
  'nav.appointments': 'Appointments',
  'nav.web_widget': 'Website assistant',
...
const hi: Partial<Record<TranslationKey, string>> = {
  ...
  'nav.playbook': 'कंपनी प्लेबुक',
  'nav.documents': 'दस्तावेज़ इनबॉक्स',
  'nav.appointments': 'अपॉइंटमेंट',
  'nav.web_widget': 'वेबसाइट सहायक',
